...
public class TeacherAddCourses1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        dropdownSemester.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Fall 2023", "Spring 2024" }));
    ...
    private void btnAddCourseT2_2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCourseT2_2ActionPerformed
        ...
        if(teachermycoursesarray.getTeacherMyCoursesArray().isEmpty()){
            ...
            teachermycourses.setImageOfCourse(imageOfMyCourse);
                ...
                for(int i=0;i<teachermycourses.getCourseSchedule().length;i++){
                    System.out.println(teachermycourses.getCourseSchedule()[i]);
                }
