...
public class TeacherUpdateCourses extends javax.swing.JPanel {
    ...
    public TeacherUpdateCourses(TeacherMyCoursesArray teachermycoursesarray, String teacherusername) {
        initComponents();
    ...
    private void btnUpdateCourseT2_3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateCourseT2_3ActionPerformed
        ...
        for (TeacherMyCourses teacherIndividualCourses : teachermycoursesarray.getTeacherMyCoursesArray()) {
            if(dropdownCourseNameT2_3.getSelectedItem().toString().equals(teacherIndividualCourses.getCourseName())){
                teacherIndividualCourses.setCatalog(txtCourseCatalogT2_3.getText());
                teacherIndividualCourses.setCoursePrice(txtCoursePriceT2_3.getText());
    ...
    private void dropdownCourseName() {
        dropdownCourseNameT2_3.addItem("Select");
        for (TeacherMyCourses teacherIndividualCourses : teachermycoursesarray.getTeacherMyCoursesArray()) {
            if(teacherIndividualCourses.getTeacherUsername().equals(teacherusername)){
                dropdownCourseNameT2_3.addItem(teacherIndividualCourses.getCourseName());
            }
    ...
    private void filldetails() {
        for (TeacherMyCourses teacherIndividualCourses : teachermycoursesarray.getTeacherMyCoursesArray()) {
            System.out.println("Course Price - "+teacherIndividualCourses.getCoursePrice());
            System.out.println("Course Name - "+teacherIndividualCourses.getCourseName());
            System.out.println("Dropdown Course Selected - "+dropdownCourseNameT2_3.getSelectedItem().toString());
            
            if(dropdownCourseNameT2_3.getSelectedItem().toString().equals(teacherIndividualCourses.getCourseName())){
                System.out.println("If loop passed ");
                txtCoursePriceT2_3.setText(teacherIndividualCourses.getCoursePrice());
                txtCourseCatalogT2_3.setText(teacherIndividualCourses.getCatalog()); 
                
                for(String CourseDay: teacherIndividualCourses.getCourseSchedule()){
                    ...
                    if(CourseDay.equals("Saturday")){
                        jCheckBoxSaturday.setSelected(true);
                    }
                    if(CourseDay.equals("Sunday")){
